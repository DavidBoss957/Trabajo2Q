    ...
    return (
        <div id="perfilContainer">
            ...
            <div id="elementosPerfil" className="mx-5 w-75">
                ...
                {/* Alias */}
                <h2 id="alias" className='text-center mt-3'>Alias</h2>
                ...
                <div>
                    ...
                    <div className="row mx-0">
                        ...
                        <p className="info col rounded-end-4 py-2" id="infoAlias">Alias</p> {/* ACTUALIZABLE */}
                    </div>
                </div>
                ...
                <div className='d-flex justify-content-center'>
                    <button type="submit" className="btn mt-4 text-center rounded-4 px-4 me-3" style={{background: '#A1A1A1'}}><div className='textoBoton'>Cerrar sesión</div></button>
