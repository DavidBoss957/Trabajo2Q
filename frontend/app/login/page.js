...
export default function Login() {
    ...
    return (
        <div id="loginContent" className="container mt-3">
            ...
            <img src="img/default.png" id="imglogin" className="img-fluid mx-auto d-block mt-5" alt="default"/>
            ...
            <div id="containerFormulario" className="d-flex justify-content-center mx-5 my-5 ">
                <form id="formLogin" className="px-5 py-5 rounded-4" onSubmit={handleComprobacion} >
                    ...
                    <h2 id="subtitulo">Iniciar sesión</h2>
                    ...
                    <div className="text-center">
                        <button type="submit" id="botonLogin" className="btn mt-4 text-center rounded-4 px-5" style={{background: '#C8C8C8'}}><div id='textoBoton'>Acceder</div></button>
                    </div>
