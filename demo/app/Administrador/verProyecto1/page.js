...
export default function ViewProjects() {
  ...
  const handleMainPageProyect = () => {
    ...
    router.push('/Administrador/MainPage/noProyecto');
  };
  ...
  const handleMainPage = () => {
    ...
    <div>
      ...
      <div class="project-buttons">
        <center><button id="editProject" className="btn btn-light">MODIFICAR PROYECTO</button></center>
        <center><button id="deleteProject" className="btn btn-dark" onClick={handleMainPageProyect}>ELIMINAR PROYECTO</button></center>
