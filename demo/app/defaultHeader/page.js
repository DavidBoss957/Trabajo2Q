...
import '../defaultHeader/defaultHeader.css';
  ...
  <nav class="miPerfil">
    <ul class="nav__list">
      <li class="nav__list-item">
        <a class="nav__link nav__link--btn" href="../perfil/page.js">Mi Perfil</a>
      </li>
      <li class="nav__list-item">
        <a class="nav__link nav__link--btn nav__link--btn--highlight" href="../subida_proyectos/done/page.js">Subir Proyecto</a>
      </li>
    </ul>
  </nav>
</header>
